namespace EnvisionedBlog.Migrations
{
    ...
    {
        public const int NumberOfUsers = 5;
        public const int NumberOfCategories = 30;
        public const int NumberOfPlaylists = 10;
        public const int RandomCategoryNameLength = 20;
        public const int RandomUserNameLength = 20;
        ...
        public SeedData()
        {
            ...
            for (int i = 0; i < NumberOfUsers; i++)
            {
                this.Users.Add(new User()
                {
                    ...
                    PasswordHash = passwordHash.HashPassword(string.Format("user{0}", i)),
                    SecurityStamp = Guid.NewGuid().ToString()
                });
            }
            ...
            Posts.Add(new Post()
            {
                ...
                ImageUrl = "http://cdn.elegantthemes.com/preview/Envisioned/wp-content/uploads/et_temp/1-214917_213x213.jpg"
            });
            Posts.Add(new Post()
            {
                Category = Categories[1],
            ...
            Posts.Add(new Post()
            {
                ...
                DateCreated = DateTime.Now.AddDays(Rand.Next(-5, 5)),
                ImageUrl = "http://cdn.elegantthemes.com/preview/Envisioned/wp-content/uploads/et_temp/feature-4-47041_213x213.jpg"
            });
            Posts.Add(new Post()
            {
            ...
            this.Comments.Add(new Comment()
            {
                Message = "I really like your blog!"
            });
            this.Comments.Add(new Comment()
            {
                Message = "Unicorns are awesome!"
            });
        }
    }
}